...
def read_image():
    images = []
    for dir_item in os.listdir('/head/two/ktFaces'):
        full_path = os.path.abspath(os.path.join('/head/two/ktFaces', dir_item))
...
def show_imgs_for_final_generator_model():
    # load model
    model = tf.keras.models.load_model('/head/two/res_one/generator_model_240.h5')
    # generate images
